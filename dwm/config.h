...
static const char col_gray4[]       = "#a1a1a1";
static const char col_cyan[]        = "#161616";
static const char col_sigma[]       = "#AAAAAA";
static const char col_bord[]        = "#6D4B55";
static const char *colors[][3]      = {
        /*               fg         bg         border   */
        [SchemeNorm] = { col_sigma, col_cyan, col_gray2 },
        [SchemeSel]  = { col_gray3, col_gray1,  col_bord  },
        [SchemeHid]  = { col_sigma,  col_cyan, col_gray2  },
};
...
static const Layout layouts[] = {
	...
	{ "<3",      NULL },    /* no layout function means floating behavior */
	{ "[M]",      monocle },
};
